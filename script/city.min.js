...
this.showProvinces=function(element){var str='<option value="0" selected>Select Province</option>';for(let i in this.getProvinces()){str+='<option value="'+this.p[i]+'">'+this.p[i]+'</option>'}
this.p=[];document.querySelector(element).innerHTML='';document.querySelector(element).innerHTML=str;this.e=element;return this}
this.showCities=function(province,element){var str='<option value="0" selected>Select City/Municipality</option>';var elem='';if((province.indexOf(".")!==-1||province.indexOf("#")!==-1)){elem=province}
else{for(let i in this.getCities(province)){str+='<option value="'+this.c[i]+'">'+this.c[i]+'</option>'}
elem=element}
